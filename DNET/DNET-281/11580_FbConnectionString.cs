...
namespace FirebirdSql.Data.FirebirdClient
{
    internal sealed class FbConnectionString
    {
        ...
        public static readonly string DEFAULT_DATASOURCE = String.Empty;
        public static readonly int DEFAULT_PORTNUMBER = 3050;
        public static readonly string DEFAULT_USERID = String.Empty;
        public static readonly string DEFAULT_PASSWORD = String.Empty;
        public static readonly string DEFAULT_ROLENAME = String.Empty;
        public static readonly string DEFAULT_CATALOG = String.Empty;
        public static readonly string DEFAULT_CHARSET = "None";
        public static readonly int DEFAULT_DIALECT = 3;
        public static readonly int DEFAULT_PACKETSIZE = 8192;
        public static readonly bool DEFAULT_POOLING = true;
        public static readonly int DEFAULT_CONNECTION_LIFETIME = 0;
        public static readonly int DEFAULT_MIN_POOLSIZE = 0;
        public static readonly int DEFAULT_MAX_POOLSIZE = 100;
        public static readonly int DEFAULT_CONNECTION_TIMEOUT = 15;
        public static readonly int DEFAULT_FETCHSIZE = 200;
        public static readonly FbServerType DEFAULT_SERVERTYPE = FbServerType.Default;
        public static readonly IsolationLevel DEFAULT_ISOLATIONLEVEL = IsolationLevel.ReadCommitted;
        public static readonly bool DEFAULT_RECORDS_AFFECTED = true;
        public static readonly bool DEFAULT_CONTEXT_CONNECTION = false;
        public static readonly bool DEFAULT_ENLIST = false;
        public static readonly string DEFAULT_CLIENTLIBRARY = "fbembed";
        #endregion
