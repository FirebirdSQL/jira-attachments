...
namespace FirebirdSql.Data.FirebirdClient
{
    public class FbConnectionStringBuilder : DbConnectionStringBuilder
    {
        ...
        {
            this.DataSource = FbConnectionString.DEFAULT_DATASOURCE;
            this.Port = FbConnectionString.DEFAULT_PORTNUMBER;
            this.UserID = FbConnectionString.DEFAULT_USERID;
            this.Password = FbConnectionString.DEFAULT_PASSWORD;
            this.Role = FbConnectionString.DEFAULT_ROLENAME;
            this.Database = FbConnectionString.DEFAULT_CATALOG;
            this.Charset = FbConnectionString.DEFAULT_CHARSET;
            this.Dialect = FbConnectionString.DEFAULT_DIALECT;
            this.PacketSize = FbConnectionString.DEFAULT_PACKETSIZE;
            this.Pooling = FbConnectionString.DEFAULT_POOLING;
            this.ConnectionLifeTime = FbConnectionString.DEFAULT_CONNECTION_LIFETIME;
            this.MinPoolSize = FbConnectionString.DEFAULT_MIN_POOLSIZE;
            this.MaxPoolSize = FbConnectionString.DEFAULT_MAX_POOLSIZE;
            this.ConnectionTimeout = FbConnectionString.DEFAULT_CONNECTION_TIMEOUT;
            this.FetchSize = FbConnectionString.DEFAULT_FETCHSIZE;
            this.ServerType = FbConnectionString.DEFAULT_SERVERTYPE;
            this.IsolationLevel = FbConnectionString.DEFAULT_ISOLATIONLEVEL;
            this.ReturnRecordsAffected = FbConnectionString.DEFAULT_RECORDS_AFFECTED;
            this.ContextConnection = FbConnectionString.DEFAULT_CONTEXT_CONNECTION;
            this.Enlist = FbConnectionString.DEFAULT_ENLIST;
            this.ClientLibrary = FbConnectionString.DEFAULT_CLIENTLIBRARY;
        }
