...
const char* XNET_MAPPED_FILE_NAME		= "Global\\%s_MAP_%"ULONGFORMAT"_%"ULONGFORMAT;

const char* XNET_CONNECT_MAP			= "Global\\%s_CONNECT_MAP";
const char* XNET_CONNECT_MUTEX			= "Global\\%s_CONNECT_MUTEX";
const char* XNET_CONNECT_EVENT			= "Global\\%s_CONNECT_EVENT";
const char* XNET_RESPONSE_EVENT			= "Global\\%s_RESPONSE_EVENT";

const char* XNET_E_C2S_DATA_CHAN_FILLED	= "Global\\%s_E_C2S_DATA_FILLED_%"ULONGFORMAT"_%"ULONGFORMAT"_%"ULONGFORMAT;
const char* XNET_E_C2S_DATA_CHAN_EMPTED	= "Global\\%s_E_C2S_DATA_EMPTED_%"ULONGFORMAT"_%"ULONGFORMAT"_%"ULONGFORMAT;
const char* XNET_E_S2C_DATA_CHAN_FILLED	= "Global\\%s_E_S2C_DATA_FILLED_%"ULONGFORMAT"_%"ULONGFORMAT"_%"ULONGFORMAT;
const char* XNET_E_S2C_DATA_CHAN_EMPTED	= "Global\\%s_E_S2C_DATA_EMPTED_%"ULONGFORMAT"_%"ULONGFORMAT"_%"ULONGFORMAT;

const char* XNET_E_C2S_EVNT_CHAN_FILLED	= "Global\\%s_E_C2S_EVNT_FILLED_%"ULONGFORMAT"_%"ULONGFORMAT"_%"ULONGFORMAT;
const char* XNET_E_C2S_EVNT_CHAN_EMPTED	= "Global\\%s_E_C2S_EVNT_EMPTED_%"ULONGFORMAT"_%"ULONGFORMAT"_%"ULONGFORMAT;
const char* XNET_E_S2C_EVNT_CHAN_FILLED	= "Global\\%s_E_S2C_EVNT_FILLED_%"ULONGFORMAT"_%"ULONGFORMAT"_%"ULONGFORMAT;
const char* XNET_E_S2C_EVNT_CHAN_EMPTED	= "Global\\%s_E_S2C_EVNT_EMPTED_%"ULONGFORMAT"_%"ULONGFORMAT"_%"ULONGFORMAT;
