...
create procedure AddUser
 (user_name varchar(128), passwd varchar(32), first_name varchar(32), middle_name varchar(32), last_name varchar(32))
 as
  begin
    if ((USER != 'SYSDBA') or
    ...
    insert into users (user_name, passwd, first_name, middle_name, last_name)
      values (UPPER(:user_name), f_IBPassword(:passwd), :first_name, :middle_name, :last_name);
  end ^
