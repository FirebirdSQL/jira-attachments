...
class xxStatus : public IStatusImpl<xxStatus, CheckStatusWrapper>
{
public:
	xxStatus(IStatus* s)
		: st(s) { }
	...
	{
		const intptr_t* qq = st->getErrors();
		if (qq[1])
			throw 0;
		return qq;
	}
